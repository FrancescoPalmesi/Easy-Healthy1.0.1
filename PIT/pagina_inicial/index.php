...
<html lang="pt-br">
  <head>
    ...
    <link rel="stylesheet" href="assets/css/laptopl.css">
    <link rel="stylesheet" href="assets/css/laptop.css">
    <link rel="stylesheet" href="assets/css/tablet.css">
    <link rel="stylesheet" href="assets/css/mobilel.css">
    <link rel="stylesheet" href="assets/css/mobilem.css">
  ...
  <body id="body">
    ...
    <section id="inicial-banner">
            ...
            <img id="imgprincipal" src="assets/img/Pagina_Inicial_1secao.png">
        
    </section>
    <div id="detalhes">
        <div id="detalhe1">
            <img src="assets/img/icon1.png" width="50%">
            <p class="txtdetalhe">Receitas de 
            diversos tipos para 
            diversas dietas</p>
        </div>
        <div id="detalhe2">
            <img src="assets/img/icon2.png" width="50%">
        ...
        <div id="detalhe4">
            <img src="assets/img/icon4.png" width="57%">
    ...
    <div class="apresentacao">
        ...
        <img src="assets/img/prato.png" id="prato" >
    </div>
    ...
    <section id="inicial-banner2">
        ...
        <img id="imgprincipal" src="assets/img/Pagina_Inicial_3secao.png">
